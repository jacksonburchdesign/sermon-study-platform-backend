...
export interface ApiSermonSermon extends Schema.CollectionType {
  ...
  attributes: {
    Chapters: Attribute.Component<'video-data.chapter', true>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::sermon.sermon',
      'oneToOne',
    ...
    watch_histories: Attribute.Relation<
      'api::sermon.sermon',
      'oneToMany',
...
export interface ApiWatchHistoryWatchHistory extends Schema.CollectionType {
